...
<head>
    <meta charset="utf-8">
    <title>Black & White Matara</title>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img style="width: 500px;height:500px;" src="<?php echo $img_src; ?>" alt="Image">
                        </div>
                        <?php
                        ...
                        <div class="carousel-item">
                            <img style="width: 500px; height: 500px;" src="<?php echo $gallery_img_src; ?>" alt="Image">
                        </div>
                        <?php } ?>
