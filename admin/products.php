                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="category.php" class="menu-link">
                                    <div data-i18n="Without menu">Cloth Category text-light</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <h3 class="mb-4" style="color:navy ;">Products List</h3>
                            </div>
                            <div class="col-lg-2">
                                <button class="btn btn-primary" style="background-color:navy ;" data-bs-toggle="modal" data-bs-target="#ProductModal">
                                    Add
                                    New</button>
                            </div>
                        </div>
...
<hr class="w-100 " style="color:navy;">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="prodcuts_edit.php?pid=<?php echo $row['pid']; ?>"
                                                ...
                                                <i class="fa-solid fa-pen-to-square "style="color:navy ;" ></i> </a>
                                            <a href="product_images.php?pid=<?php echo $row['pid']; ?>"
                                                class="btn btn-darkblue">
                                                <i class="fas fa-images" style="color:navy ;"></i> </a>
                                            <a href="reviews.php?pid=<?php echo $row['pid']; ?>"
                                                class="btn btn-darkblue" style="color:navy ;">
