                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <h3 class="mb-4" style="color:navy ;">Message List</h3>
                            </div>
                        </div>
                        <hr>
                        <div class="table-responsive">
                            <table id="datatablesSimple" class="table table-bordered">
                                <thead style="background-color:palevioletred;" class="text-dark">
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                                        <th>Email</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button"
                                                ...
                                                class="btn btn-darkblue" style="color:navy"> <i class="fa-solid fa-trash"></i> </button>
                                        </td>
