         ...
         <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-center py-2 flex-md-row flex-column bg-dark text-light">
                <div class="mb-2 mb-md-0">
                  ©
                  <script>
                    document.write(new Date().getFullYear());
                  </script>
                  Black & White Matara. All rights reserved
                  - Created By <span class="text-warning">A.G.A.P.C.AKMEEMANA</span>
