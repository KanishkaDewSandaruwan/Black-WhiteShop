                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <h3 class="mb-4" style="color:navy ;">Product Category List</h3>
                            </div>
                            <div class="col-lg-2">
                                <button class="btn btn-primary" style="background-color:navy ;" data-bs-toggle="modal" data-bs-target="#CategoryModal">
                                    Add
                                    New</button>
                            </div>
                        </div>
                                ...
                                $img_src = "../server/uploads/category/".$img;?>
                                    <tr>
                                        ...
                                        <td><button type="button"
                                                ...
                                                class="btn btn-darkblue text-light" style="background-color:navy ;"> <i class="fa-solid fa-trash"></i>
                                            </button></td>
                                    </tr>
