        ...
        <div class="layout-container" style="background-image:url(../img/pattern.png );">
            ...
            <div class="app-brand demo mt-3" >
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item active text-light">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <h3 class="mb-4" style="color:navy ;">Product Color List</h3>
                            </div>
                            <div class="col-lg-2">
                                <button class="btn btn-primary" style="background-color:navy ;" data-bs-toggle="modal" data-bs-target="#ColorModal">
                                    Add
                                    New</button>
                            </div>
                        </div>
                                ...
                                $color_id = $row['color_id'];;?>
                                    <tr>
                                        ...
                                        <td><button type="button"
                                                ...
                                                class="btn  text-left" style="background-color:navy ;"> <i class="fa-solid fa-trash"></i>
                                            </button></td>
                                    </tr>
