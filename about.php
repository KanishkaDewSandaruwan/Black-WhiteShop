   ...
   <div class="container-fluid">
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h1 class="section-title px-5"><span class="px-2">About Us</span></h1>
        </div>
           <div class="row g-5 align-items-center">
           <div class="col-lg-6">
               <img src="img/269259603_863416114339159_7883370478172454120_n.png" style="height:300px;width:300px;">

            </div>
            <div class="col-lg-6">
                <h2 class="mb-4 text-center" style="color:midnightblue;"><?php echo $res['about_title']; ?></h2>
                <p class="mb-4 text-center"><?php echo $res['about_desc']; ?></p>
