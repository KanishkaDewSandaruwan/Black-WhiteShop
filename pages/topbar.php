...
<div class="container-fluid">
    <div class="row text-white py-2 px-xl-5" style="background-color:#1c2841 ;">
    ...
    <div class="row align-items-center py-0 px-xl-2">
        ...
        <div class="col-lg-3  app-brand demo mt-3">
                    <a href="index.php" >
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button type="button" onclick="search(this.form)" class="input-group-text bg-transparent " style="color:#1c2841 ;">
        ...
        <div class="col-lg-3 col-6 text-right">
            <a href="cart.php" class="btn border">
                <i class="fas fa-shopping-cart " style="color:#1c2841 ;"></i>
                <?php if(isset($_SESSION['customer'])) : ?>
